...
public class WidgetFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view1 = inflater.inflate(R.layout.news_item, container, true);
        ...
        quantity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Drawable icon = ContextCompat.getDrawable(getContext(), R.drawable.btn_home);
        ...
        font_size.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                int checkedItem = 1; // Vị trí của "Bình thường" trong mảng fontSizeOptions
